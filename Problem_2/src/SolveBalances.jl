...
# ----------------------------------------------------------------------------------- #
function SolveAdjBalances(TSTART,TSTOP,Ts,adj_initial_condition_vector,parameter_index,data_dictionary)
  ...
  (t,y) = ode23s(fbalances,adj_initial_condition_vector,TSIM;points=:specified); # Deleted minstep=0.0001*epsilon

  # Map -
  number_of_timesteps = length(t)
  number_of_states = length(adj_initial_condition_vector)
